  ...
  return (
    <div className="w-full">
      ...
      <div className="mt-8 space-y-3 text-sm">
        {showCategories && (
          <div>
            <p className="text-gray-400 font-semibold mb-2">Categoría</p>
        ...
        <div>
          <p className="text-gray-400 font-semibold mb-2">Vista</p>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            <div className="flex items-center gap-2">
        ...
        <div>
          <p className="text-gray-400 font-semibold mb-2">Estado</p>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            <div className="flex items-center gap-2">
