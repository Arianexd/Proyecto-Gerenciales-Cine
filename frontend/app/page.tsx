      ...
      {!loading && featuredMovie && (
        <section className="relative h-[85vh] w-full overflow-hidden">
          ...
          <div className="container mx-auto px-4 h-full flex flex-col md:flex-row items-center justify-center gap-12 relative z-10 pt-20">
            <div className="w-56 md:w-80 shrink-0 shadow-[0_0_50px_rgba(220,38,38,0.3)] rounded-2xl overflow-hidden border border-gray-200 dark:border-white/10 transform hover:scale-105 transition-transform duration-700">
            ...
            <div className="max-w-3xl text-center md:text-left">
              <div className="flex items-center justify-center md:justify-start gap-3 mb-6">
                ...
                <span className="text-gray-600 dark:text-gray-400 text-sm font-bold tracking-tight">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-lg md:text-xl mb-10 line-clamp-3 font-medium leading-relaxed max-w-xl">
      ...
      <div className="container mx-auto px-4 py-24 space-y-32">
        ...
        <section>
                ...
                <button
                  ...
                  className={`px-6 py-2.5 rounded-xl text-xs font-black transition-all border-2 ${
                    selectedGenre === genre
                      ...
                      : 'bg-gray-200 dark:bg-white/5 border-gray-200 dark:border-white/5 text-gray-600 dark:text-gray-500 hover:border-gray-300 dark:hover:border-white/20 hover:text-gray-900 dark:hover:text-white'
                  }`}
                >
          ...
          {loading ? (
            ...
            <div className="text-center py-32 bg-gray-200 dark:bg-white/5 rounded-[40px] border border-gray-300 dark:border-white/5">
...
function SkeletonCard() {
  return (
    <div className="space-y-6 animate-pulse">
      <div className="aspect-[2/3] bg-gray-200 dark:bg-white/5 rounded-3xl" />
  ...
  return (
    <Link href={`/movies/${movie._id}`} className="group block">
      <div className="relative aspect-[2/3] rounded-[32px] overflow-hidden mb-6 shadow-2xl transition-all duration-700 group-hover:scale-[1.03] group-hover:-translate-y-3">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-gray-50 dark:from-gray-950 via-transparent to-transparent opacity-80" />
        
        <div className="absolute top-4 left-4 flex flex-col gap-2">
          <span className="px-3 py-1.5 bg-white/80 dark:bg-black/60 text-gray-900 dark:text-white backdrop-blur-xl rounded-xl text-[9px] font-black border border-gray-200 dark:border-white/10 uppercase tracking-widest">
        ...
        <div className="absolute inset-x-6 bottom-6 translate-y-10 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
          <div className="w-full py-4 bg-gray-900 dark:bg-white text-white dark:text-black rounded-2xl text-[10px] font-black text-center shadow-2xl uppercase tracking-widest">
